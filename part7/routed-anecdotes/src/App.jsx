  ...
  return (
    <div>
      ...
      <form onSubmit={handleSubmit}>
        <div>
          content
          <input name='content' type={content.type} onChange={content.onChange} value={content.value} />
        </div>
        <div>
          author
    ...
    <div>
      <h1>Software anecdotes</h1>
        ...
        <Routes>
          ...
          <Route path='/anecdotes/:id' element={<AnecdoteId anecdote={anecdote} />} />
        </Routes>
        <Footer />
    </div>
